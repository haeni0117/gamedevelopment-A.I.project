...
public class text_4_2_3 : MonoBehaviour
...
//  //소//
    private static string text_소파="소파 가죽을 의미 없이 긁어보았다. \n진짜 가죽이 아니라 \n인조 가죽이지만 비싼 돈을 주고 \n산 만큼 광택이 흐른다.";
    //tv
    private static string text_TV="이제는 TV를 \n쳐다보는 것조차 \n꺼림직하게 느껴진다";
    //스피커
    private static string text_스피커="스피커는 지금 필요 없다.";
    //거실테이블
    private static string text_거실테이블_0="거실 테이블 위 스마트폰을 \n집어 올렸다.\n\n그래,\n통신은 안되지만\n블루투스는 작동할 거야!";
    private static string text_거실테이블_1="{스마트폰을 획득했다!}";
    private static string text_거실테이블_2="어서 스마트홈 어플을 작동시켜보자.";
    private static string text_거실테이블_3="스마트홈 어플에서 1층 베란다 문을 누르니 문이 열렸다.";

    private static string text_7="[ 아빠가 접종은 다 맞춰서 보내준대. 응? ]\n\n[ 입양 공고는 올렸어? ]";
    private static string text_8="[ 웬만하면 믿을 수 있는 사람한테 맡기고 싶단 말이야. 이상한 사람한테 보냈다가 \n학대라도 당하면 어떡해? 평생 죄책감에 시달릴 거야. ]";
