...
public class text7_2 : MonoBehaviour
{
...
//(4)iot쓰레기통
    ...
    { 
        typingText2 = GameObject.Find("general text2").GetComponent<Text>();
        Debug.Log("typingtext"+typingText);
        Debug.Log("message"+message);
    ...
    private static string text_1="[ 1,2,3의 순서에 맞게 의수 고치기가 진행됩니다. 순서대로 진행하세요. ]";
    private static string text_2="[ 경고 : 순서대로 진행하시오. ]";
    private static string text_3="[ 경고 : 순서대로 진행하시오. ]";
...
//     private static string text_17="같은 브랜드의 의수를 계속 \n사용해왔으니 예전에 사용하던 \n의수에서 내장 칩을 얻을 수 \n있을 것이다. ";
    ...
    void Start()
    {
       ...
       스킵.onClick.AddListener(text7_2.스킵버튼클릭);//adlistner로 불러오려면 static void여야 한다.
