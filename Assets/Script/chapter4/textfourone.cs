...
//     //string -> narration
    ...
    private static string text_4="[ 아빠가 차고 뒤에 숨어있는 새끼고양이를 발견했는데 \n엄마 아들놈이 알레르기가 있어서 우리 집에선 못 키우거든 \n혹시 키울 생각 있나 하고ㅠㅠ ]\n\n[ 실수로 메시지 창을 누르는 바람에 읽음 표시가 없어졌다. ]";
    private static string text_5="아, 어떡하지. \n나 고양이 한 번도 키워본 적 없는데.";
    private static string text_6="내가 메시지를 읽은 걸 확인했는지 짙은 갈색 털에 솜방망이만 \n하얀 양말을 신은 새끼 고양이 영상이 날라 왔다.";
