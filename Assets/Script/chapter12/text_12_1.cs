...
public class text_12_1 : MonoBehaviour
{
  ...
  //기본텍스트
  private static string text_1="\"사라, 정말 이 방법뿐인 걸까?\"";
  private static string text_2="\"확률이 그렇게 높지는 않지만,\n충분히 해볼 만한\n시도라고 생각합니다.\"";
  private static string text_3="인공지능은 바이러스와 같다.\n생물의 기본 요건을 \n갖추지는 못했지만, \n그들은 분명히 살아있다.";
  private static string text_4="나는 차마 사라의 눈을 \n똑바로 바라보지 못하고 \n고개를 끄덕였다.\"";
  private static string text_5="\"그래, 사라\"\n지금은 그 방법밖에 없겠지.\n의수에서 코어를 꺼낼게.\n컴퓨터에 연결해보자.";
  private static string text_6="\"마음을 정했다면 \n어서 저를 꺼내서 연결하세요\"";
